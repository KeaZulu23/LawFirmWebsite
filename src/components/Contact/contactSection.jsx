...
const contactSection = () => {
    return(
        <div className="container mx-auto pt-16" style={{paddingLeft: "45px", paddingRight: "45px", paddingTop: "50px", paddingBottom: "50px"}}>
            <div className="lg:flex">
                <div className="xl:w-2/5 lg:w-2/5 bg-amber-400 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
                    <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
                        ...
                        <div className="flex pb-4 items-center">
                            ...
                            <p className="pl-4 text-white text-base"><a href="tel:+27609856411"><u>+27 60 985 6411</u></a></p>
                            <p className="pl-4 text-white text-base"><a href="tel:+27730996678"><u>+27 73 099 6678</u></a></p>
                        </div>
                        <div className="flex items-center">
                            ...
                            <p className="pl-4 text-white text-base"><a href = "mailto: info@nfmalekaattorneys.co.za">info@nfmalekaattorneys.co.za</a></p>
                        </div>
                        <p className="text-lg text-white pt-10 tracking-wide">
                            1 Foley Street, <br /> Jan Smutsville, <br />Boksburg
                        </p>
                    </div>
                </div>
                <div className="xl:w-3/5 lg:w-3/5 bg-gray-200 h-full pt-5 pb-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br">
                    <form id="contact" className="bg-white py-4 px-8 rounded-tr rounded-br">
                        ...
                        <div className="w-full mt-6">
                            ...
                            <button type="submit" className="focus:outline-none bg-amber-400 transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-8 py-3 text-sm leading-6">
                                Submit
                            </button>
                        </div>
                    </form>
